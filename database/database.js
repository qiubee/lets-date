...
const { dbuser, dbpw, dbhost, dbname } = require("../config");

async function connect (callback) {
	const uri = "mongodb+srv://" + dbuser + ":" + dbpw + "@" + dbhost + "/" + dbname;
	const client = new MongoClient(uri, {
		useNewUrlParser: true,
		useUnifiedTopology: true
	});
	console.log("\u001b[1m\u001b[37m-- \u001b[32mConnecting to " + dbhost + " \u001b[37m--\u001b[0m");
	try {
		await client.connect();
		console.log("\u001b[1m\u001b[37m-- \u001b[32mConnected \u001b[37m--\u001b[0m");
		console.log("\u001b[37mAccess granted\u001b[0m");
		const db = client.db(dbname);
		console.log("\u001b[37mYou have access to database: " + dbname + "\u001b[0m");
